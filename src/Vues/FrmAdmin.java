...
//        for (etats e : fm.GetIdEtat())
//        {
//            cboEtatsTickets.addItem(e.getNomCategorie());
//        }
    }//GEN-LAST:event_formWindowOpened

    private void tblUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsersMouseClicked
        
        int numUser = Integer.parseInt(tblUsers.getValueAt(tblUsers.getSelectedRow(), 0).toString());      //mdlFormations = new ModelFormation(); 
      mdlTicket.loadDatas(fm.GetAllTicketsByIdUser(numUser));
       tblTickets.setModel(mdlTicket); // Affichage
    ...
    private void btnInsererNouveauTicketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererNouveauTicketMouseClicked
        ...
        if(txtNumTicket.getText().compareTo("") == 0)
        {
            // On affiche un message
            JOptionPane.showMessageDialog(null,
                    "Veuillez saisir un numéro de ticket", "Erreur de saisie",
        ...
        else if (txtNomTicket.getText().compareTo("") == 0)
        {
         ...
         {
//             int num = Integer.parseInt(txtNumTicket.getText());
//             String nom = txtNomTicket.getText();
//             et = cboEtatsTickets.getSelectedItem().toString();
//             e = new Etat(0,"","");
//             lesTickets  = new Tickets(num, nom, e);
//             fm.insereJeu(lesTickets, et);
//             
//             ModelTicket = new ModelTicket();
//             ModelTicket.LoadDatas(fm.GetAllTickets());
